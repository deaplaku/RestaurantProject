                ...
                <div class="row justify-content-center">
                    ...
                    // ...
                        while ($row = mysqli_fetch_assoc($result)) {
                            ...
                            $bgColor = ($reservationResult && mysqli_num_rows($reservationResult) > 0)
                                ? 'rgb(248, 222, 34)'
                                : $box_color;

                            echo '<div class="btn btn-primary btn-block btn-lg" style="pointer-events: none; cursor: default; '
                                . 'background-color: ' . $bgColor . '; justify-content: center; align-items: center; display: flex; '
                                . 'width: 9rem; height: 9rem;">'
                                . 'Table: ' . $table_id . '<br>Capacity: ' . $capacity . '</div>';
