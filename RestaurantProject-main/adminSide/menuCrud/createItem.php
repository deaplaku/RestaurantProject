...
<div class="wrapper">
    ...
    <form method="POST" action="success_create.php" class="ht-600 w-50">
        ...
        <div class="form-group">
            ...
            <select name="item_type" id="item_type" class="form-control placeholder=" Select Item
                    Type" <?php echo (!empty($itemtype_err)) ? 'is-invalid' : ''; ?>" required>
        ...
        <div class="form-group">
            ...
            <input min='0.01' type="number" name="item_price" id="item_price" placeholder="12.34" step="0.01" required
                   class="form-control <?php echo (!empty($itemprice_err)) ? 'is-invalid' : ''; ?>"><br>
            <span class="invalid-feedback"></span>
        </div>
